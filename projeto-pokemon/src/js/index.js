/*
    O que precisamos fazer? - quando clicarmos no botão de troca de tema temos que alterar a cor do tema da página 
...
// passo 1 const é uma variável de valor constante
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if(modoEscuroEstaAtivo) {       
        ...
        // passo 8
        imagemBotaoTrocaDeTema.setAttribute("src", "./projeto-pokemon/src/imagens/sun.png")
        ...
        // passo 5
        imagemBotaoTrocaDeTema.setAttribute("src", "./projeto-pokemon/src/imagens/moon.png")
    } 
